...
const forEachArray = [];
array.forEach((item) => {
  forEachArray.push(item.username + "!");
})
...
// Counter? or Index
// (2)
const arrayNumNew = [1, 2, 4, 5, 8, 9];
const newArrayNew = arrayNumNew.map((num, i) => {
  return num * 2;
})
console.log(newArrayNew)

//BONUS: create a new list with all user information, but add "!" to the end of each items they own.
const markArray = array.map(user => {
